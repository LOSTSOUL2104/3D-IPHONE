...
*/
// since this file was in glb format so I converted it to jsx format using a tool!! // I also removed the unnecessary comments and code to make it more readable.
